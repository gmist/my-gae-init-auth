...
class ConfigUpdateForm(wtf.Form):
  ...
  odnoklassniki_app_id = wtforms.StringField('Odnoklassniki App ID', filters=[util.strip_filter])
  odnoklassniki_app_secret = wtforms.StringField('Odnoklassniki App Secret', filters=[util.strip_filter])
  odnoklassniki_consumer_public = wtforms.StringField('Odnoklassniki Consumer Public', filters=[util.strip_filter])
