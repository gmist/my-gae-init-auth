...
class ConfigUpdateForm(wtf.Form):
  ...
  odnoklassniki_app_id = wtf.StringField('Odnoklassniki App ID', filters=[util.strip_filter])
  odnoklassniki_app_secret = wtf.StringField('Odnoklassniki App Secret', filters=[util.strip_filter])
  odnoklassniki_consumer_public = wtf.StringField('Odnoklassniki Consumer Public', filters=[util.strip_filter])
